...
인코딩 타입을 multipart/form-data 로 지정해야 한다. -->
	<form name="frm" method="post" enctype="multipart/form-data" action="${contextPath}/admin/product/add">
		<table id="list">
			<tr>
				<th>상품분류</th>
		...
		<input class="btn" type="button" value="목록 가기" onClick="window.location='${contextPath}/admin/product/productList'">
